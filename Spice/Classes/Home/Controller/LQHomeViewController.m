...
#pragma mark - 数据请求
- (void)readData{
    [NetWorkRequestManager requestWithType:GET urlString:@"http://toutiao.com/ma/?media_id=5234320301&count=10&max_behot_time=0&callback=jsonp1&csrfmiddlewaretoken=undefined&_=1460604968522" parDic:nil finish:^(NSData *data) {
